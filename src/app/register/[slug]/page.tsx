        ...
        <div className="grid grid-cols-1 lg:grid-cols-11 gap-8">
          ...
          <div className="lg:col-span-8">
            ...
            <div className="mb-12 rounded-2xl overflow-hidden bg-black aspect-video relative">
              {/* Gradient background */}
              <div className="absolute inset-0 bg-gradient-to-br from-blue-600 via-purple-600 to-pink-600 opacity-60"></div>
            ...
            <div className="prose prose-invert prose-lg max-w-none">
              <ReactMarkdown
                ...
                components={{
                  ...
                  // Sanitize images - use Next.js Image component
                  img: ({src, alt, ...props}) => {
          ...
          <div className="lg:col-span-3">
            <div className="sticky top-24 space-y-6">
              ...
              <div className="p-6 rounded-2xl bg-black/50 border border-neutral-800">
                <h3 className="text-sm font-semibold mb-4 text-neutral-400">ON THIS PAGE</h3>
                <nav className="space-y-2 text-sm">
                  <a href="#overview" className="block text-neutral-300 hover:text-white transition-colors">Event Overview</a>
                  <a href="#rules" className="block text-neutral-300 hover:text-white transition-colors">Rules and Guidelines</a>
                  <a href="#prizes" className="block text-neutral-300 hover:text-white transition-colors">Prize Details</a>
                  <a href="#contact" className="block text-neutral-300 hover:text-white transition-colors">Contact Information</a>
                </nav>
              </div>
