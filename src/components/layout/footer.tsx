...
function Footer() {
  ...
  return (
    <footer className='relative w-full min-h-screen bg-black text-white overflow-hidden flex flex-col'>
      ...
      <div className='relative z-10 px-8 lg:px-16 pb-12 mt-6'>
        <div className='flex flex-col md:flex-row justify-between items-start md:items-center gap-6 text-sm text-white/60'>
          <div className='flex flex-col md:flex-row gap-4 md:gap-8'>
            <span>All copyrights @roboticsclub_SRMCEM</span>
      ...
      <div className='relative z-10 flex-1 flex items-center justify-center py-20'>
        <h2 
          className='text-[10vw] md:text-[18vw] lg:text-[20vw] font-bold tracking-tighter leading-none font-barbara'
          style={{
