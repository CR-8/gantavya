...
const faqData = [
  {
    question: "How can I register for the Robotics Event?",
    answer:
      "To register, visit our official event website and fill out the registration form under the “Register” section. You’ll receive a confirmation email with your participant ID and event details once your registration is complete. Early registration is advised, as slots for each competition are limited.",
  },
  {
    question: "What categories of competitions are available?",
    answer:
      "The event features multiple robotics challenges including Line Follower Robot (LFR) Race, Robo Race, Robo War, and RC Buggy Race. Each event tests different aspects of design, control, and strategy — from speed and precision to endurance and combat performance.",
  }
];
